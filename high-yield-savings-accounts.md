...
Rates as of March 22, 2026. National average savings APY: **0.39%**.

## Highest APY Accounts

| Rank | Bank | APY | Notes |
|------|------|-----|-------|
| 1 | Varo Bank | **5.00%** | Only on balances up to $5,000; requires direct deposit |
| 2 | Axos Bank | **4.21%** | Requires direct deposit and balance minimums; no physical branches |
| 3 | Newtek Bank | **4.20%** | No minimum, no monthly fee; currently waitlist-only due to demand |
| 4 | Wealthfront | **4.20%** | Cash account (brokerage, not a bank — FDIC-insured via partners) |
...
- The Fed cut rates three times in late 2025; rates are trending lower but still strong.
- Another rate cut is unlikely before Q2 2026.
- All rates are variable and can change at any time.
