...
- `c_hot` **Hot water** [fact] Hot water at the counter, on demand. The shop produces it rather than buying it. "The hot water comes from a kettle" (sentence 4)
- `c_tea` **Tea leaves** [fact] Tea bought in from a wholesaler, delivered next day at a price the owner describes as pennies. "We buy the tea from a wholesaler" (sentence 5)
- `c_cup` **Cups** [fact] Cups bought from a catering supplier, next-day delivery, negligible unit cost. "the cups from a catering supplier; both arrive the next day and cost pennies" (sentence 5)
- `c_kettle` **Kettles** [fact] Four commercial kettles chosen from a catalogue: one of several substitutable models on the market. "The kettle is a commercial model we picked out of a catalogue, and we bought four of them." (sentence 6)
- `c_staff` **Staff boiling and descaling** [fact] The manual practice of boiling, refilling and descaling kettles: an hour of staff time every morning. "our staff spend the first hour of every morning boiling, refilling and descaling kettles" (sentence 8)
- `c_water` **Mains water** [fact] Water from the mains, needed by the kettle. "the kettle needs water and power" (sentence 4)
- `c_power` **Electric power** [fact] Electricity from the wall, metered and billed by the unit; nobody in the shop thinks about it. "Power comes out of the wall and we pay by the unit; nobody here thinks about it." (sentence 7)

Evolution stage (schema: the same four markers in every map, no quote and no confidence)

- `s1` **I Genesis** [schema] Genesis: the component is novel and uncertain; it is built by hand because nothing to buy exists yet.
- `s2` **II Custom-built** [schema] Custom-built: the component is understood well enough to build deliberately, but every instance is bespoke.
- `s3` **III Product (+rental)** [schema] Product: competing, substitutable versions can be bought or rented; the differences are features, not existence.
- `s4` **IV Commodity (+utility)** [schema] Commodity or utility: the component is undifferentiated, metered and bought without thought.
...
- `c7` **Powered data-centre shells** [fact] The layer Kant names as the real bottleneck: bringing chips and power together into powered shells that are actually online. "The actual bottleneck is bringing it all together and actually having powered shells like data centers online." (Eiso Kant, L4380)
