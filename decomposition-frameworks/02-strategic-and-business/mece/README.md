...
Sixteen of the twenty-four nodes and four of the thirty-six edges are facts, none of them paraphrases. Quotes keep the transcript's mis-hearings — "a bridge" for Abridge, "commier" for Commure, "RV" for Harvey, "Zendaz" for Zendesk, "Ripling" for Rippling — with the corrected spelling in `entities`.
...
Eight derived nodes and thirty-two derived edges. Fact nodes are referenced by id.
